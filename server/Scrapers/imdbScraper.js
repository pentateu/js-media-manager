...
var ERROR_IMDB_CLOSE_RESPONSE = IMDBScraper.ERROR_IMDB_CLOSE_RESPONSE = Util.exception({code:55002, message:"Response has closed before the complete payload could be received."});
